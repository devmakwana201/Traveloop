const ru: Record<string, string> = {
  ...
  'settings.about.description': 'Traveloop — это самостоятельно размещаемый планировщик путешествий, который помогает организовать поездки от первой идеи до последнего воспоминания. Планирование по дням, бюджет, списки вещей, фото и многое другое — всё в одном месте, на вашем собственном сервере.',
  ...
  'admin.weather.description': 'Traveloop использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.update.confirmText': 'Traveloop будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} теперь доступен.',
  ...
  'notif.version_available.text': 'Traveloop {version} теперь доступен',
  ...
  'system_notice.v3_mcp.body': 'Интеграция MCP была полностью переработана. OAuth 2.1 теперь является рекомендуемым методом аутентификации. Статические токены (traveloop_…) устарели и будут удалены в будущей версии.',
