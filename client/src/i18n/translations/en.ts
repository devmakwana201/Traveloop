const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.ntfyUrl.topicPlaceholder': 'my-traveloop-alerts',
  ...
  'admin.notifications.adminNtfyPanel.topicPlaceholder': 'traveloop-admin-alerts',
  ...
  'settings.about.supporters.title': 'Travel companions for Traveloop',
  'settings.about.supporters.subtitle': "While you're planning your next route, these folks are helping plan Traveloop's future. Their monthly contribution goes straight into development and real hours spent — so Traveloop stays Open Source.",
  ...
  'settings.about.description': 'Traveloop is an intelligent travel planning platform that helps you organize your trips from the first idea to the last memory. Day planning, budget tracking, packing lists, community feed, and much more — all in one place.',
  ...
  'login.createAdminHint': 'Set up the first admin account for Traveloop.',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your Traveloop experience.',
  ...
  'admin.weather.description': 'Traveloop uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building Traveloop',

  'admin.update.available': 'Update available',
  'admin.update.text': 'Traveloop {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText': 'Traveloop will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText': 'Your Traveloop instance runs in Docker. To update to {version}, run the following commands on your server:',
  ...
  'vacay.sharingHint': 'Share your vacation plan with other Traveloop users',
  'vacay.owner': 'Owner',
  'vacay.shareEmailPlaceholder': 'Email of Traveloop user',
  ...
  'vacay.inviteHint': 'Invite another Traveloop user to share a combined vacation calendar.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} is now available.',
  ...
  'notif.version_available.text': 'Traveloop {version} is now available',
  ...
  'journey.pdf.madeWith': 'Made with Traveloop',
  'journey.pdf.day': 'Day',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Static traveloop_ tokens deprecated',
  ...
  'system_notice.welcome_v1.title': 'Welcome to Traveloop',
  'system_notice.welcome_v1.body': 'Your personalized travel planning platform. Build itineraries, track budgets, share trips with friends, and discover community-curated routes — online or offline.',
  'system_notice.welcome_v1.cta_label': 'Plan a trip',
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with Traveloop planning UI overlay',
