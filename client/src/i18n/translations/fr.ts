const fr: Record<string, string> = {
  ...
  'settings.about.description': 'Traveloop est un planificateur de voyage auto-hébergé qui vous aide à organiser vos voyages de la première idée au dernier souvenir. Planification journalière, budget, listes de bagages, photos et bien plus — le tout au même endroit, sur votre propre serveur.',
  ...
  'admin.weather.description': 'Traveloop utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.update.text': 'Traveloop {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText': 'Traveloop sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} est maintenant disponible.',
  ...
  'notif.version_available.text': 'Traveloop {version} est maintenant disponible',
