const nl: Record<string, string> = {
  ...
  'settings.about.description': 'Traveloop is een zelf-gehoste reisplanner die je helpt je reizen te organiseren van het eerste idee tot de laatste herinnering. Dagplanning, budget, paklijsten, foto\'s en nog veel meer — alles op één plek, op je eigen server.',
  ...
  'admin.weather.description': 'Traveloop gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.update.text': 'Traveloop {version} is beschikbaar. Je draait {current}.',
  'admin.update.button': 'Bekijk op GitHub',
  'admin.update.install': 'Update installeren',
  'admin.update.confirmTitle': 'Update installeren?',
  'admin.update.confirmText': 'Traveloop wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} is nu beschikbaar.',
  ...
  'notif.version_available.text': 'Traveloop {version} is nu beschikbaar',
  ...
  'system_notice.v3_mcp.body': 'De MCP-integratie is volledig vernieuwd. OAuth 2.1 is nu de aanbevolen authenticatiemethode. Statische tokens (traveloop_…) zijn verouderd en worden verwijderd in een toekomstige versie.',
