const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.description': 'Traveloop to samodzielnie hostowany planer podróży, który pomaga organizować wyprawy od pierwszego pomysłu po ostatnie wspomnienie. Planowanie dzienne, budżet, listy pakowania, zdjęcia i wiele więcej — wszystko w jednym miejscu, na własnym serwerze.',
  ...
  'admin.weather.description': 'Traveloop korzysta z Open-Meteo jako źródła danych pogodowych. Open-Meteo to darmowy, otwartoźródłowy serwis pogodowy — klucz API nie jest wymagany.',
  ...
  'admin.update.confirmText': 'Traveloop zostanie zaktualizowany z {current} do {version}. Serwer zostanie automatycznie zrestartowany po zakończeniu.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} jest już dostępny.',
  ...
  'notif.version_available.text': 'Traveloop {version} jest teraz dostępny',
  ...
  'system_notice.v3_mcp.body': 'Integracja MCP została całkowicie przeprojektowana. OAuth 2.1 jest teraz zalecaną metodą uwierzytelniania. Statyczne tokeny (traveloop_…) są przestarzałe i zostaną usunięte w przyszłej wersji.',
