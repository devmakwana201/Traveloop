const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.description': 'Traveloop é um planejador de viagens auto-hospedado que ajuda você a organizar suas viagens da primeira ideia à última lembrança. Planejamento diário, orçamento, listas de bagagem, fotos e muito mais — tudo em um só lugar, no seu próprio servidor.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} já está disponível.',
  ...
  'notif.version_available.text': 'Traveloop {version} está disponível',
  ...
  'system_notice.v3_mcp.body': 'A integração MCP foi completamente reformulada. OAuth 2.1 agora é o método de autenticação recomendado. Tokens estáticos (traveloop_…) foram descontinuados e serão removidos em uma versão futura.',
