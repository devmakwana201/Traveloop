const es: Record<string, string> = {
  ...
  'settings.about.description': 'Traveloop es un planificador de viajes autoalojado que te ayuda a organizar tus viajes desde la primera idea hasta el último recuerdo. Planificación diaria, presupuesto, listas de equipaje, fotos y mucho más — todo en un solo lugar, en tu propio servidor.',
  ...
  'admin.weather.description': 'Traveloop utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.update.text': 'Traveloop {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText': 'Traveloop se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} ya está disponible.',
  ...
  'notif.version_available.text': 'Traveloop {version} ya está disponible',
  ...
  'system_notice.v3_mcp.body': 'La integración MCP ha sido completamente renovada. OAuth 2.1 es ahora el método de autenticación recomendado. Los tokens estáticos (traveloop_…) están obsoletos y se eliminarán en una versión futura.',
