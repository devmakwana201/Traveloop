...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.description': 'Traveloop هو مخطط سفر مستضاف ذاتيًا يساعدك على تنظيم رحلاتك من أول فكرة حتى آخر ذكرى. تخطيط يومي، ميزانية، قوائم تعبئة، صور والمزيد — كل شيء في مكان واحد، على خادمك الخاص.',
  ...
  'admin.update.text': 'Traveloop {version} متوفر. أنت تستخدم {current}.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} متاح الآن.',
  ...
  'notif.version_available.text': 'Traveloop {version} متاح الآن',
  ...
  'system_notice.v3_mcp.body': 'تمت إعادة تصميم تكامل MCP بالكامل. OAuth 2.1 هو الآن طريقة المصادقة الموصى بها. الرموز الثابتة (traveloop_…) مهملة وستُزال في إصدار مستقبلي.',
