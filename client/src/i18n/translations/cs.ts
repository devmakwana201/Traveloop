const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.description': 'Traveloop je samohostovaný plánovač cest, který vám pomůže organizovat výlety od prvního nápadu po poslední vzpomínku. Denní plánování, rozpočet, balicí seznamy, fotky a mnoho dalšího — vše na jednom místě, na vašem vlastním serveru.',
  ...
  'admin.weather.description': 'Traveloop používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'Traveloop {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText': 'Traveloop bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} je nyní k dispozici.',
  ...
  'notif.version_available.text': 'Traveloop {version} je nyní dostupný',
  ...
  'system_notice.v3_mcp.body': 'Integrace MCP byla kompletně přepracována. OAuth 2.1 je nyní doporučenou metodou ověřování. Statické tokeny (traveloop_…) jsou zastaralé a budou v budoucí verzi odstraněny.',
