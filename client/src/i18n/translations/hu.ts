const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'vacay.shareEmailPlaceholder': 'Traveloop felhasználó e-mail címe',
  ...
  'system_notice.v3_mcp.body': 'Az MCP integráció teljesen megújult. Az OAuth 2.1 mostantól az ajánlott hitelesítési módszer. A statikus tokenek (traveloop_…) elavultak és egy jövőbeli kiadásban eltávolításra kerülnek.',
