const zh: Record<string, string> = {
  ...
  'settings.about.description': 'Traveloop 是一个自托管的旅行规划工具，帮助你从最初的想法到最后的回忆，全程组织你的旅行。日程规划、预算、行李清单、照片等——一切尽在一处，在你自己的服务器上。',
  ...
  'admin.weather.description': 'Traveloop 使用 Open-Meteo 作为天气数据源。Open-Meteo 是免费的开源天气服务——无需 API 密钥。',
  ...
  'admin.update.text': 'Traveloop {version} 已发布。你当前使用的是 {current}。',
  'admin.update.button': '在 GitHub 查看',
  'admin.update.install': '安装更新',
  'admin.update.confirmTitle': '确定安装更新？',
  'admin.update.confirmText': 'Traveloop 将从 {current} 更新到 {version}。服务器将自动重启。',
  ...
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'Traveloop 用户邮箱',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} 现已可用。',
  ...
  'notif.version_available.text': 'Traveloop {version} 现已可用',
  ...
  'system_notice.v3_mcp.body': 'MCP 集成已全面重构。OAuth 2.1 现为推荐的身份验证方式。静态令牌（traveloop_…）已弃用，将在未来版本中移除。',
