const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.description': 'Traveloop ist ein selbst gehosteter Reiseplaner, der dir hilft, deine Trips von der ersten Idee bis zur letzten Erinnerung zu organisieren. Tagesplanung, Budget, Packlisten, Fotos und vieles mehr — alles an einem Ort, auf deinem eigenen Server.',
  ...
  'admin.weather.description': 'Traveloop nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.',
  ...
  'admin.update.text': 'Traveloop {version} ist verfügbar. Du verwendest {current}.',
  ...
  'admin.update.confirmText': 'Traveloop wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} ist jetzt verfügbar.',
  ...
  'notif.version_available.text': 'Traveloop {version} ist jetzt verfügbar',
  ...
  'system_notice.v3_mcp.body': 'Die MCP-Integration wurde vollständig überarbeitet. OAuth 2.1 ist jetzt die empfohlene Authentifizierungsmethode. Statische Tokens (traveloop_…) sind veraltet und werden in einer zukünftigen Version entfernt.',
