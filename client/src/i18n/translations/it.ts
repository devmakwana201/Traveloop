const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.description': 'Traveloop è un pianificatore di viaggi self-hosted che ti aiuta a organizzare i tuoi viaggi dalla prima idea all\'ultimo ricordo. Pianificazione giornaliera, budget, liste bagagli, foto e molto altro — tutto in un unico posto, sul tuo server.',
  ...
  'admin.weather.description': 'Traveloop utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.update.text': 'Traveloop {version} è disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText': 'Traveloop verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} è ora disponibile.',
  ...
  'notif.version_available.text': 'Traveloop {version} è ora disponibile',
