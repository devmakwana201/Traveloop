const zhTw: Record<string, string> = {
  ...
  'settings.about.description': 'Traveloop 是一款自架旅遊規劃器，幫助您從最初構想到最後回憶，整理每次旅行。日程規劃、預算、行李清單、照片及更多功能——全部集中在您自己的伺服器上。',
  ...
  'admin.weather.description': 'Traveloop 使用 Open-Meteo 作為天氣資料來源。Open-Meteo 是免費的開源天氣服務——無需 API 金鑰。',
  ...
  'admin.update.text': 'Traveloop {version} 已釋出。你當前使用的是 {current}。',
  'admin.update.button': '在 GitHub 檢視',
  'admin.update.install': '安裝更新',
  'admin.update.confirmTitle': '確定安裝更新？',
  'admin.update.confirmText': 'Traveloop 將從 {current} 更新到 {version}。伺服器將自動重啟。',
  ...
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'Traveloop 使用者郵箱',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} 現已推出。',
  ...
  'notif.version_available.text': 'Traveloop {version} 現已推出',
  ...
  'system_notice.v3_mcp.body': 'MCP 整合已全面重構。OAuth 2.1 現為建議的身份驗證方式。靜態令牌（traveloop_…）已棄用，將於未來版本移除。',
...
export default zhTw// Traveloop – Travel Planning Platform 2026
