const id: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.description': 'Traveloop adalah perencana perjalanan self-hosted yang membantu kamu mengatur perjalanan dari ide pertama hingga kenangan terakhir. Perencanaan harian, anggaran, daftar bawaan, foto dan masih banyak lagi — semua di satu tempat, di servermu sendiri.',
  ...
  'admin.weather.description': 'Traveloop menggunakan Open-Meteo sebagai sumber data cuaca. Open-Meteo adalah layanan cuaca gratis dan open-source — tidak perlu kunci API.',
  ...
  'admin.update.text': 'Traveloop {version} tersedia. Kamu menggunakan {current}.',
  'admin.update.button': 'Lihat di GitHub',
  'admin.update.install': 'Pasang Pembaruan',
  'admin.update.confirmTitle': 'Pasang Pembaruan?',
  'admin.update.confirmText': 'Traveloop akan diperbarui dari {current} ke {version}. Server akan restart otomatis setelahnya.',
  ...
  'notifications.versionAvailable.text': 'Traveloop {version} kini tersedia.',
  ...
  'notif.version_available.text': 'Traveloop {version} kini tersedia',
  ...
  'system_notice.v3_mcp.body': 'Integrasi MCP telah sepenuhnya diperbarui. OAuth 2.1 kini menjadi metode autentikasi yang direkomendasikan. Token statis (traveloop_…) sudah usang dan akan dihapus pada versi mendatang.',
