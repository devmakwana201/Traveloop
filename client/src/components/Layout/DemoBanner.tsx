...
const texts: Record<string, DemoTexts> = {
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Traveloop',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: 5 }}>
            {t.titleBefore}<span style={{ color: '#0ea5e9', fontWeight: 800 }}>Traveloop</span>{t.titleAfter}
          </h2>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: '#9ca3af' }}>
            ...
            <a href="https://traveloop.app" target="_blank" rel="noopener noreferrer"
