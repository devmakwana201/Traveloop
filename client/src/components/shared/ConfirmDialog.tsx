...
export default function ConfirmDialog({
  ...
  return (
    <div
      className="fixed inset-0 z-[10000] flex items-center justify-center px-4 tl-backdrop-enter"
      style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', paddingBottom: 'var(--bottom-nav-h)' }}
      onClick={onClose}
    >
      <div
        className="tl-modal-enter rounded-2xl shadow-2xl w-full max-w-sm p-6"
