              ...
              {isLoading ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-slate-100 tl-stagger">
                      {users.map(u => (
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder='https://auth.example.com/application/o/traveloop/.well-known/openid-configuration'
                      className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-400 focus:border-transparent"
                    />
                ...
                <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
                  ...
                  <div className={`p-6 space-y-3 ${!emailActive ? 'opacity-50 pointer-events-none' : ''}`}>
                    {smtpLoaded && [
                      ...
                      { key: 'smtp_user', label: 'SMTP User', placeholder: 'hello@traveloop.com' },
                      { key: 'smtp_pass', label: 'SMTP Password', placeholder: '••••••••', type: 'password' },
                      { key: 'smtp_from', label: 'From Address', placeholder: 'hello@traveloop.com' },
                    ].map(field => (
                      <div key={field.key}>
        ...
        >
          ...
          >
            ...
            <div style={{ padding: '20px 24px' }}>
              ...
              >
{`docker pull traveloop/app:latest
docker stop traveloop && docker rm traveloop
