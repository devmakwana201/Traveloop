...
export default function LoginPage(): React.ReactElement {
  ...
  useEffect(() => {
    ...
    const CONFIG_CACHE_KEY = 'traveloop_app_config_cache'
        ...
        <div className="takeoff-logo" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, marginBottom: 48 }}>
            <svg viewBox="0 0 36 36" width="48" height="48" fill="none">
              <circle cx="18" cy="18" r="18" fill="rgba(14,165,233,0.2)"/>
              <path d="M10 24 L18 8 L26 24" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
              <circle cx="18" cy="22" r="3" fill="#0ea5e9"/>
            </svg>
            <span style={{ fontSize: 32, fontWeight: 800, color: 'white', letterSpacing: '-0.5px', fontFamily: "'Inter', sans-serif" }}>Traveloop</span>
          </div>
      ...
      <div style={{ display: 'none', width: '55%', background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%)', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '60px 48px', position: 'relative', overflow: 'hidden' }}
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 560, textAlign: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, marginBottom: 48 }}>
              ...
              <span style={{ fontSize: 28, fontWeight: 800, color: 'white', letterSpacing: '-0.5px' }}>Traveloop</span>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, marginBottom: 36 }}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <svg viewBox="0 0 36 36" width="36" height="36" fill="none">
                ...
                <path d="M10 24 L18 8 L26 24" stroke="#0ea5e9" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                <circle cx="18" cy="22" r="3" fill="#0ea5e9"/>
              </svg>
              <span style={{ fontSize: 22, fontWeight: 800, color: '#111827', letterSpacing: '-0.3px' }}>Traveloop</span>
            </div>
          ...
          <div style={{ background: 'white', borderRadius: 20, border: '1px solid #e5e7eb', padding: '36px 32px', boxShadow: '0 2px 16px rgba(0,0,0,0.06)' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <button type="submit" disabled={isLoading} style={{
                marginTop: 4, width: '100%', padding: '12px', background: '#0ea5e9', color: 'white',
                border: 'none', borderRadius: 12, fontSize: 14, fontWeight: 700, cursor: isLoading ? 'default' : 'pointer',
                fontFamily: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                opacity: isLoading ? 0.7 : 1, transition: 'opacity 0.15s, background 0.15s',
              }}
                onMouseEnter={(e: React.MouseEvent<HTMLButtonElement>) => { if (!isLoading) e.currentTarget.style.background = '#0284c7' }}
                onMouseLeave={(e: React.MouseEvent<HTMLButtonElement>) => { if (!isLoading) e.currentTarget.style.background = '#0ea5e9' }}
              >
                {isLoading
